...
function Collapse(props) {
    ...
    if(fold){
        return (
            <div class="collapse">
                <button class="collapse__button" onClick={() => setFold(false)}>
                    {props.title}
        ...
        return (
            <div class="collapse collapse--unfolded">
                <button class="collapse__button " onClick={() => setFold(true)}>
                    {props.title}
                ...
                <div class="collapse__desc">{props.children}</div>
            </div>
        )
    }
